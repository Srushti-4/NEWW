...
export const SKILLS = {
  ...
  'Frontend Technologies': [
    ...
    { name: 'JavaScript', icon: '⚡', color: '#fef3c7', level: 80 },
    { name: 'React.js', icon: '⚛️', color: '#dbeafe', level: 75 },
  ],
  'Backend Frameworks': [
    { name: 'Spring Boot', icon: '🍃', color: '#d1fae5', level: 78 },
    { name: 'REST API', icon: '🔗', color: '#ede9fe', level: 82 },
  ],
  'IDE': [
    { name: 'Eclipse', icon: '🌑', color: '#ede9fe', level: 80 },
    { name: 'VS Code', icon: '💙', color: '#dbeafe', level: 90 },
    { name: 'IntelliJ', icon: '🧠', color: '#fee2e2', level: 78 },
  ],
  'Data & Cloud': [
    { name: 'Databricks', icon: '⚡', color: '#fce7f3', level: 85 },
  ...
  'Tools & Methods': [
    ...
    { name: 'Software Testing', icon: '🧪', color: '#d1fae5', level: 80 },
    { name: 'Git', icon: '🌿', color: '#d1fae5', level: 82 },
  ],
};
